 ...
 * @param bool $EntryID Used by the function when recursively calling (should never be defined outside of recursive calls).
 * @param bool $Final Used by the function when recursively calling (should never be defined outside of recursive calls).
 * @return string|array|bool Returned data depends upon context (read further into the code and documentation for a better understanding).
 */
...
/**
 * Deletes old "bannedips.csv" file after 1 week (a fresh copy will be re-created anew).
 */
...
/**
 * Deletes cache information for the request rate quota and requests count after 1 day.
 */
